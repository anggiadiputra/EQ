...
class LandingSettingsController extends Controller
{
    ...
    {
        \Log::info('Landing settings update request', [
        ...
        return back()->with('success', "{$updated} setting halaman utama berhasil diperbarui");
    }

    private function getGroupName()
    {
        return 'Pengaturan Halaman Utama';
    }
}
