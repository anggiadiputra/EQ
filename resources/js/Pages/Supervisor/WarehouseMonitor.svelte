<script>
  ...
  function getActivityIcon(type) {
    const icons = {
      'box_created': 'cube',
      'box_sealed': 'check-circle',
      'item_packed': 'document-text',
      'task_assigned': 'pencil-square',
...
<AdminLayout>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4 sm:p-6">
      <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
        ...
        <div class="flex flex-wrap gap-2 sm:gap-3">
          ...
          >
            <HeroIcon name="arrow-path" class="w-4 h-4 sm:w-5 sm:h-5 {refreshing ? 'animate-spin' : ''}" />
          ...
          >
            <HeroIcon name="arrow-down-tray" class="w-4 h-4 sm:w-5 sm:h-5" />
          ...
          >
            <HeroIcon name="cube" class="w-4 h-4 sm:w-5 sm:h-5" />
          ...
          >
            <HeroIcon name="plus" class="w-4 h-4 sm:w-5 sm:h-5" />
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4 md:p-6 hover:shadow-lg transition-shadow">
      <div class="flex items-center justify-between mb-4">
        <div class="w-10 h-10 rounded-lg bg-purple-50 text-purple-600 flex items-center justify-center">
          <HeroIcon name="inbox-stack" class="w-5 h-5" />
        </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4 md:p-6 hover:shadow-lg transition-shadow">
      <div class="flex items-center justify-between mb-4">
        <div class="w-10 h-10 rounded-lg bg-indigo-50 text-indigo-600 flex items-center justify-center">
          <HeroIcon name="users" class="w-5 h-5" />
        </div>
  ...
  <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6 mb-6 sm:mb-8">
      ...
      <div class="p-4 sm:p-6">
                ...
                <div class="flex flex-col sm:flex-row sm:justify-between sm:items-start mb-4 space-y-2 sm:space-y-0">
                  ...
                  <div class="flex items-center gap-2 flex-shrink-0">
                    ...
                    <button
                      ...
                      title="Update target"
                    >
                      <HeroIcon name="pencil-square" class="w-4 h-4 sm:w-5 sm:h-5" />
                    </button>
                  </div>
                </div>
        ...
        {:else}
          <div class="text-center py-12 text-gray-500">
            <HeroIcon name="inbox-stack" class="w-16 h-16 mx-auto mb-4 text-gray-300" />
            ...
            >
              ...
              <span>Assign Target Sekarang</span>
            </button>
          </div>
        {/if}
      </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100">
      ...
      <div class="p-4 sm:p-6">
          ...
          <div class="space-y-3 max-h-80 sm:max-h-96 overflow-y-auto">
            {#each recentActivities as activity}
              <div class="flex items-start gap-3 p-3 hover:bg-gray-50 rounded-lg transition-colors">
                <div class="w-8 h-8 rounded-lg bg-gray-100 text-gray-700 flex items-center justify-center flex-shrink-0">
        ...
        {:else}
          <div class="text-center py-12 text-gray-500">
            <HeroIcon name="clock" class="w-12 h-12 mx-auto mb-4 text-gray-300" />
  ...
  <div class="bg-white rounded-xl shadow-sm border border-gray-100">
    ...
    <div class="p-4 sm:p-6">
      ...
      {:else}
        <div class="text-center py-12 text-gray-500">
          <HeroIcon name="chart-bar" class="w-16 h-16 mx-auto mb-4 text-gray-300" />
          ...
          <form on:submit|preventDefault={handleAssignTarget} class="space-y-6">
            ...
            <div>
              ...
              <div class="mt-2 flex items-center gap-2">
                <HeroIcon name="information-circle" class="w-4 h-4 text-blue-500" />
      ...
      <div class="bg-white rounded-xl shadow-xl p-6 max-w-6xl w-full max-h-[90vh] overflow-y-auto">
        <div class="flex items-center justify-between mb-8">
          <div class="flex items-center gap-3">
            <div class="p-2 bg-blue-100 rounded-lg">
              <HeroIcon name="cube" class="w-6 h-6 text-blue-600" />
            </div>
            <div>
        ...
        {#if stockInfo.details && stockInfo.details.length > 0}
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 mb-6">
            <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-4 sm:p-5 border border-blue-200">
              <div class="flex items-center mb-3">
                <HeroIcon name="document-text" class="w-5 h-5 text-blue-600 mr-2" />
            ...
            <div class="bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-xl p-4 sm:p-5 border border-yellow-200">
              <div class="flex items-center mb-3">
                <HeroIcon name="exclamation-triangle" class="w-5 h-5 text-yellow-600 mr-2" />
            ...
            <div class="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-4 sm:p-5 border border-green-200">
              <div class="flex items-center mb-3">
                <HeroIcon name="chart-bar" class="w-5 h-5 text-green-600 mr-2" />
          ...
          <div class="flex justify-between items-center pt-4 border-t border-gray-200">
            <div class="text-sm text-gray-500">
              Terakhir diperbarui: <span class="font-medium">{stockInfo.last_updated}</span>
            </div>
            <button 
              on:click={() => showStockModal = false}
        ...
        {:else}
          <div class="text-center py-16 text-gray-500">
            <HeroIcon name="cube" class="w-20 h-20 mx-auto mb-4 text-gray-300" />
