    ...
    <section class="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-white to-red-50 overflow-hidden pt-32 pb-20">
      ...
      <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center mt-12">
          <a 
            href="/mushaf-request" 
            class="inline-flex items-center justify-center px-8 py-4 bg-[#eb3434] hover:bg-red-600 text-white font-semibold rounded-xl transition-colors shadow-lg"
          >
          ...
          <a 
            ...
            class="inline-flex items-center justify-center px-8 py-4 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-xl transition-colors shadow-lg"
          >
            <span class="mr-2">🔍</span>
            Cek Permintaan
          </a>
          ...
          <a 
            href="/tracking" 
            class="inline-flex items-center justify-center px-8 py-4 bg-green-600 hover:bg-green-700 text-white font-semibold rounded-xl transition-colors shadow-lg"
          >
            <span class="mr-2">📦</span>
            Cek Resi Pengiriman
          </a>
          ...
          <a 
            href="/" 
            class="inline-flex items-center justify-center px-8 py-4 border-2 border-[#eb3434] text-[#eb3434] hover:bg-[#eb3434] hover:text-white font-semibold rounded-xl transition-colors"
          >
            <span class="mr-2">🏠</span>
            Kembali ke Beranda
          </a>
