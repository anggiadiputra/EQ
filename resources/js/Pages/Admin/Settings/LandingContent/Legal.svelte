<script>
  ...
  export let group = 'legal';
  export const groupName = 'Legal';
  export let filters = {};
  ...
  function applyFilters() {
    ...
    router.get('/admin/settings/landing-content/legal', params, {
      preserveState: true,
      preserveScroll: true
    });
  }
  ...
  function resetFilters() {
    ...
    router.get('/admin/settings/landing-content/legal', { group }, {
      preserveState: true,
      preserveScroll: true
    });
  }
  ...
  function saveSetting(settingId) {
    ...
    if (setting.type === 'image' || setting.type === 'file') {
      ...
      router.post('/admin/settings/landing-content/legal', formData, {
        preserveScroll: true,
        onSuccess: (page) => {
      ...
      router.post('/admin/settings/landing-content/legal', {
        settings: [{
          id: setting.id,
          value: setting.value
        }]
  ...
  <div class="max-w-7xl mx-auto">
      ...
      <div class="flex items-center justify-between">
        <div>
          <nav class="flex items-center space-x-2 text-sm text-gray-500 mb-4">
            ...
            <span>/</span>
            <span class="text-gray-900">Legal</span>
          </nav>
          <h1 class="text-3xl font-bold text-gray-900">Pengaturan Legal</h1>
          <p class="mt-2 text-gray-600">Kelola dokumen legal seperti privacy policy, terms of service, dan disclaimer</p>
        </div>
      </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <!-- Search -->
        <div>
          <label for="search-settings-legal" class="block text-sm font-medium text-gray-700 mb-2">Cari Setting</label>
          <div class="relative">
            <input
              type="text"
        ...
        <!-- Status Filter -->
        <div>
          <label for="status-filter-legal" class="block text-sm font-medium text-gray-700 mb-2">Status</label>
          <select
        ...
        <!-- Visibility Filter -->
        <div>
          <label for="visibility-filter-legal" class="block text-sm font-medium text-gray-700 mb-2">Visibility</label>
          <select
      ...
      <div class="p-6">
        <div class="flex items-center justify-between mb-6">
          <h2 class="text-xl font-semibold text-gray-900">
            Pengaturan Legal ({currentSettings.length})
          </h2>
        </div>
        ...
        {:else}
          <div class="text-center py-12">
            <HeroIcon name="document-text" class="mx-auto h-12 w-12 text-gray-400" />
            <h3 class="mt-2 text-sm font-medium text-gray-900">Belum ada pengaturan legal</h3>
            <p class="mt-1 text-sm text-gray-500">Mulai dengan menambahkan dokumen legal seperti privacy policy dan terms of service.</p>
            <div class="mt-6">
              <a
                href="/admin/settings/create?group=legal"
