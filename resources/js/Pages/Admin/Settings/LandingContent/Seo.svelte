<script>
  ...
  export let group = 'seo';
  export const groupName = 'SEO';
  export let filters = {};
  ...
  function applyFilters() {
    ...
    router.get('/admin/settings/landing-content/seo', params, {
      preserveState: true,
      preserveScroll: true
    });
  }
  ...
  function resetFilters() {
    ...
    router.get('/admin/settings/landing-content/seo', { group }, {
      preserveState: true,
      preserveScroll: true
    });
  }
  ...
  function saveSetting(settingId) {
    ...
    if (setting.type === 'image' || setting.type === 'file') {
      ...
      router.post('/admin/settings/landing-content/seo', formData, {
        preserveScroll: true,
        onSuccess: (page) => {
      ...
      router.post('/admin/settings/landing-content/seo', {
        settings: [{
          id: setting.id,
          value: setting.value
        }]
  ...
  <div class="max-w-7xl mx-auto">
      ...
      <div class="flex items-center justify-between">
        <div>
          <nav class="flex items-center space-x-2 text-sm text-gray-500 mb-4">
            ...
            <span>/</span>
            <span class="text-gray-900">SEO</span>
          </nav>
          <h1 class="text-3xl font-bold text-gray-900">Pengaturan SEO</h1>
          <p class="mt-2 text-gray-600">Kelola pengaturan SEO seperti meta title, meta description, keywords, dan Open Graph</p>
        </div>
      </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <!-- Search -->
        <div>
          <label for="search-settings-seo" class="block text-sm font-medium text-gray-700 mb-2">Cari Setting</label>
          <div class="relative">
            <input
              id="search-settings-seo"
              type="text"
        ...
        <!-- Status Filter -->
        <div>
          <label for="status-filter-seo" class="block text-sm font-medium text-gray-700 mb-2">Status</label>
          <select
            id="status-filter-seo"
        ...
        <!-- Visibility Filter -->
        <div>
          <label for="visibility-filter-seo" class="block text-sm font-medium text-gray-700 mb-2">Visibility</label>
          <select
            id="visibility-filter-seo"
      ...
      <div class="p-6">
        <div class="flex items-center justify-between mb-6">
          <h2 class="text-xl font-semibold text-gray-900">
            Pengaturan SEO ({currentSettings.length})
          </h2>
        </div>
        ...
        {:else}
          <div class="text-center py-12">
            <HeroIcon name="light-bulb" class="mx-auto h-12 w-12 text-gray-400" />
            <h3 class="mt-2 text-sm font-medium text-gray-900">Belum ada pengaturan SEO</h3>
            <p class="mt-1 text-sm text-gray-500">Mulai dengan menambahkan pengaturan SEO seperti meta title, description, dan keywords.</p>
            <div class="mt-6">
              <a
                href="/admin/settings/create?group=seo"
                class="inline-flex items-center gap-1 px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-[#eb3434] hover:bg-red-600"
              >
