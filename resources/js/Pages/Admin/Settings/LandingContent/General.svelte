<script>
  ...
  export let group = 'general';
  export const groupName = 'General';
  export let filters = {};
  ...
  function applyFilters() {
    ...
    router.get('/admin/settings/landing-content/general', params, {
      preserveState: true,
      preserveScroll: true
    });
  }
  ...
  function resetFilters() {
    ...
    router.get('/admin/settings/landing-content/general', { group }, {
      preserveState: true,
      preserveScroll: true
    });
  }
  ...
  function saveSetting(settingId) {
    ...
    if (setting.type === 'image' || setting.type === 'file') {
      ...
      router.post('/admin/settings/landing-content/general', formData, {
        preserveScroll: true,
        onSuccess: (page) => {
      ...
      router.post('/admin/settings/landing-content/general', {
        settings: [{
          id: setting.id,
          value: setting.value
        }]
  ...
  <div class="max-w-7xl mx-auto">
    ...
    <div class="mb-8">
      <div class="flex items-center justify-between">
        <div>
          ...
          <h1 class="text-3xl font-bold text-gray-900">Pengaturan General</h1>
          <p class="mt-2 text-gray-600">Kelola pengaturan dasar aplikasi seperti nama, logo, dan informasi umum</p>
        </div>
      </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <!-- Search -->
        <div>
          <label for="search_input" class="block text-sm font-medium text-gray-700 mb-2">Cari Setting</label>
          <div class="relative">
            <input
              id="search_input"
              type="text"
        ...
        <!-- Visibility Filter -->
        <div>
          <label for="visibility_filter" class="block text-sm font-medium text-gray-700 mb-2">Visibility</label>
          <select
      ...
      <div class="p-6">
        <div class="flex items-center justify-between mb-6">
          <h2 class="text-xl font-semibold text-gray-900">
            Pengaturan General ({currentSettings.length})
          </h2>
        </div>
        ...
        {:else}
          <div class="text-center py-12">
            ...
            <h3 class="mt-2 text-sm font-medium text-gray-900">Belum ada pengaturan general</h3>
            <p class="mt-1 text-sm text-gray-500">Mulai dengan menambahkan pengaturan general seperti nama aplikasi, logo, dan informasi dasar lainnya.</p>
            <div class="mt-6">
              <a
                href="/admin/settings/create?group=general"
