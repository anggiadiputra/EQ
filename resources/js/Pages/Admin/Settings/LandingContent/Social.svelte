<script>
  ...
  export let group = 'social';
  export const groupName = 'Social Media';
  export let filters = {};
  ...
  function applyFilters() {
    ...
    router.get('/admin/settings/landing-content/social', params, {
      preserveState: true,
      preserveScroll: true
    });
  }
  ...
  function resetFilters() {
    ...
    router.get('/admin/settings/landing-content/social', { group }, {
      preserveState: true,
      preserveScroll: true
    });
  }
  ...
  function saveSetting(settingId) {
    ...
    if (setting.type === 'image' || setting.type === 'file') {
      ...
      router.post('/admin/settings/landing-content/social', formData, {
        preserveScroll: true,
        onSuccess: (page) => {
      ...
      router.post('/admin/settings/landing-content/social', {
        settings: [{
          id: setting.id,
          value: setting.value
        }]
  ...
  <div class="max-w-7xl mx-auto">
    ...
    <div class="mb-8">
      <div class="flex items-center justify-between">
        <div>
          ...
          <h1 class="text-3xl font-bold text-gray-900">Pengaturan Social Media</h1>
          <p class="mt-2 text-gray-600">Kelola link media sosial seperti Facebook, Instagram, Twitter, YouTube, dan WhatsApp</p>
        </div>
      </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <!-- Search -->
        <div>
          <label for="search-settings-social" class="block text-sm font-medium text-gray-700 mb-2">Cari Setting</label>
          <div class="relative">
            <input
              type="text"
        ...
        <!-- Status Filter -->
        <div>
          <label for="status-filter-social" class="block text-sm font-medium text-gray-700 mb-2">Status</label>
          <select
        ...
        <!-- Visibility Filter -->
        <div>
          <label for="visibility-filter-social" class="block text-sm font-medium text-gray-700 mb-2">Visibility</label>
          <select
      ...
      <div class="p-6">
        <div class="flex items-center justify-between mb-6">
          <h2 class="text-xl font-semibold text-gray-900">
            Pengaturan Social Media ({currentSettings.length})
          </h2>
        </div>
        ...
        {:else}
          <div class="text-center py-12">
            ...
            <div class="mt-6">
              <a
                href="/admin/settings/create?group=social"
