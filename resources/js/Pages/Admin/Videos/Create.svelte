<script>
  ...
  $: {
    if (form.video_url) {
      const thumbnailUrl = getThumbnailUrl(form.video_url);
  ...
  <div class="max-w-4xl mx-auto">
    ...
    <div class="mb-8">
      <div class="flex items-center gap-4 mb-4">
        ...
        <div>
          <h1 class="text-3xl font-bold text-gray-900">Tambah Video</h1>
          <p class="mt-2 text-gray-600">Tambahkan video YouTube baru</p>
        </div>
      </div>
    </div>
